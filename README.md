...
Concept for wearable glasses that function as a computer, controlled using voice and gesture input.
...
Collection of machine learning projects exploring different types of models and data.

* Built Artificial Neural Network (ANN) models for numerical data
* Applied Natural Language Processing (NLP) to analyze text data
* Developed a Convolutional Neural Network (CNN) for image-based tasks
* Created predictive models using real-world datasets (bike sharing)

These projects focus on training models, understanding how they learn patterns, and evaluating performance across different types of data.
...
I’m also exploring machine learning and neural networks, and how they can connect with hardware systems.
